...
* [Protocol layer](protocol_layer.md) ([`slink_prot_layer`](../src/slink_prot_layer.sv) module)
* [Data Link layer](data_link_layer.md) ([`slink_link_layer`](../src/slink_link_layer.sv) module)
* [Channel Allocator](channel_allocator.md) ([`slink_ch_alloc`](../src/channel_allocator/slink_ch_alloc.sv) module)
* [Physical layer](physical_layer.md) ([`slink_phys_layer`](../src/slink_phys_layer.sv) module)
...
| `apb_req_t`   | `struct`       | `apb` request struct defined with `APB_BUS_TYPEDEF` macro                                                                                                                                                |
| `apb_rsp_t`   | `struct`       | `apb` response struct defined with `APB_BUS_TYPEDEF` macro                                                                                                                                               |
...
| `clk_sl_i`      | `logic`                        | Clock for `slink_prot_layer`, `slink_link_layer`, `slink_ch_alloc` and `slink_phys_layer`. Intended for clock gating purposes, otherwise connect to `clk_i`                           |
| `rst_sl_ni`     | `logic`                        | Asynchronous reset, active low. Resets `slink_prot_layer`, `slink_link_layer`, `slink_ch_alloc` and `slink_phys_layer`. Intended for SW reset purposes, otherwise connect to `rst_ni` |
| `clk_reg_i`     | `logic`                        | Clock for `apb_req_i` and `apb_rsp_o`                                                                                                                                                                            |
| `rst_reg_ni`    | `logic`                        | Asynchronous active-low reset for `apb_req_i` and `apb_rsp_o`                                                                                                                                                    |
...
| `apb_req_i`     | `apb_req_t`                    | `apb` request port for configuration registers                                                                                                                                                    |
| `apb_rsp_o`     | `apb_rsp_t`                    | `apb` response port for configuration registers                                                                                                                                                   |
