...
module serial_link_single_channel_delay_line_reg_top #(
  ...
  // To HW
  output serial_link_single_channel_delay_line_reg_pkg::serial_link_single_channel_delay_line_reg2hw_t reg2hw, // Write
  input  serial_link_single_channel_delay_line_reg_pkg::serial_link_single_channel_delay_line_hw2reg_t hw2reg, // Read
  ...
  import serial_link_single_channel_delay_line_reg_pkg::* ;
  ...
  logic [4:0] quadrature_clock_delay_wd;
  ...
  always_comb begin
    addr_hit = '0;
    addr_hit[ 0] = (reg_addr == SERIAL_LINK_SINGLE_CHANNEL_DELAY_LINE_CTRL_OFFSET);
    addr_hit[ 1] = (reg_addr == SERIAL_LINK_SINGLE_CHANNEL_DELAY_LINE_ISOLATED_OFFSET);
    addr_hit[ 2] = (reg_addr == SERIAL_LINK_SINGLE_CHANNEL_DELAY_LINE_RAW_MODE_EN_OFFSET);
    addr_hit[ 3] = (reg_addr == SERIAL_LINK_SINGLE_CHANNEL_DELAY_LINE_RAW_MODE_IN_CH_SEL_OFFSET);
    addr_hit[ 4] = (reg_addr == SERIAL_LINK_SINGLE_CHANNEL_DELAY_LINE_RAW_MODE_IN_DATA_VALID_OFFSET);
    addr_hit[ 5] = (reg_addr == SERIAL_LINK_SINGLE_CHANNEL_DELAY_LINE_RAW_MODE_IN_DATA_OFFSET);
    ...
    addr_hit[ 9] = (reg_addr == SERIAL_LINK_SINGLE_CHANNEL_DELAY_LINE_RAW_MODE_OUT_EN_OFFSET);
    addr_hit[10] = (reg_addr == SERIAL_LINK_SINGLE_CHANNEL_DELAY_LINE_FLOW_CONTROL_FIFO_CLEAR_OFFSET);
  ...
  always_comb begin
    wr_err = (reg_we &
              ((addr_hit[ 0] & (|(SERIAL_LINK_SINGLE_CHANNEL_DELAY_LINE_PERMIT[ 0] & ~reg_be))) |
               (addr_hit[ 1] & (|(SERIAL_LINK_SINGLE_CHANNEL_DELAY_LINE_PERMIT[ 1] & ~reg_be))) |
               (addr_hit[ 2] & (|(SERIAL_LINK_SINGLE_CHANNEL_DELAY_LINE_PERMIT[ 2] & ~reg_be))) |
               (addr_hit[ 3] & (|(SERIAL_LINK_SINGLE_CHANNEL_DELAY_LINE_PERMIT[ 3] & ~reg_be))) |
               (addr_hit[ 4] & (|(SERIAL_LINK_SINGLE_CHANNEL_DELAY_LINE_PERMIT[ 4] & ~reg_be))) |
               (addr_hit[ 5] & (|(SERIAL_LINK_SINGLE_CHANNEL_DELAY_LINE_PERMIT[ 5] & ~reg_be))) |
               (addr_hit[ 6] & (|(SERIAL_LINK_SINGLE_CHANNEL_DELAY_LINE_PERMIT[ 6] & ~reg_be))) |
               (addr_hit[ 7] & (|(SERIAL_LINK_SINGLE_CHANNEL_DELAY_LINE_PERMIT[ 7] & ~reg_be))) |
               (addr_hit[ 8] & (|(SERIAL_LINK_SINGLE_CHANNEL_DELAY_LINE_PERMIT[ 8] & ~reg_be))) |
               (addr_hit[ 9] & (|(SERIAL_LINK_SINGLE_CHANNEL_DELAY_LINE_PERMIT[ 9] & ~reg_be))) |
               (addr_hit[10] & (|(SERIAL_LINK_SINGLE_CHANNEL_DELAY_LINE_PERMIT[10] & ~reg_be))) |
               (addr_hit[11] & (|(SERIAL_LINK_SINGLE_CHANNEL_DELAY_LINE_PERMIT[11] & ~reg_be)))));
  end
  ...
  assign raw_mode_in_data_valid_re = addr_hit[4] & reg_re & !reg_error;

  assign raw_mode_in_data_re = addr_hit[5] & reg_re & !reg_error;

  assign raw_mode_out_ch_mask_we = addr_hit[6] & reg_we & !reg_error;
  assign raw_mode_out_ch_mask_wd = reg_wdata[0];

  assign raw_mode_out_data_fifo_we = addr_hit[7] & reg_we & !reg_error;
  assign raw_mode_out_data_fifo_wd = reg_wdata[15:0];

  assign raw_mode_out_data_fifo_ctrl_clear_we = addr_hit[8] & reg_we & !reg_error;
  assign raw_mode_out_data_fifo_ctrl_clear_wd = reg_wdata[0];

  assign raw_mode_out_data_fifo_ctrl_fill_state_re = addr_hit[8] & reg_re & !reg_error;

  assign raw_mode_out_data_fifo_ctrl_is_full_re = addr_hit[8] & reg_re & !reg_error;

  assign raw_mode_out_en_we = addr_hit[9] & reg_we & !reg_error;
  assign raw_mode_out_en_wd = reg_wdata[0];

  assign flow_control_fifo_clear_we = addr_hit[10] & reg_we & !reg_error;
  assign flow_control_fifo_clear_wd = reg_wdata[0];

  assign quadrature_clock_delay_we = addr_hit[11] & reg_we & !reg_error;
  assign quadrature_clock_delay_wd = reg_wdata[4:0];
...
module serial_link_single_channel_delay_line_reg_top_intf
#(
  parameter int AW = 6,
  localparam int DW = 32
) (
